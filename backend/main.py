...
app = FastAPI(title="PestiCare Backend API", lifespan=lifespan)
...
async def analyze_image(
    ...
    # --- Step 3: Call Gemini ---
    # Determine the target language based on the request
    lang_map = {"ur": "Urdu", "en": "English"}
    ...
    4. Provide a local pesticide equivalent that is available locally in Pakistan for the recommended active ingredient.
    5. Provide the location or type of stores where this local pesticide might be found in Pakistan.

    CRITICAL INSTRUCTION: You MUST translate and write ALL of the output values (disease, pesticide, dosage, instructions, localPesticide, availabilityLocation) into the {target_lang} language. Ensure the keys remain in English, but only the values should be translated to {target_lang}.
    ...
    {{
      ...
      "localPesticide": "string (Local equivalent in Pakistan)",
      "availabilityLocation": "string (Where to find it in Pakistan)"
    }}
    """
